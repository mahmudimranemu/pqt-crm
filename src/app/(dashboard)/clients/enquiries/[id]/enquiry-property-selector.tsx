...
import { updateEnquiryProperties } from "@/lib/actions/enquiries";
...
export function EnquiryPropertySelector({
  ...
  function toggleProperty(propertyId: string) {
    ...
    startTransition(async () => {
      try {
        await updateEnquiryProperties(enquiryId, newRefs);
        router.refresh();
      } catch {
        toast({ variant: "destructive", title: "Error", description: "Failed to update properties" });
      }
    });
  }
